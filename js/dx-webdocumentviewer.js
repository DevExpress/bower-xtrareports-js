...
(function (DevExpress) {
    ...
    (function (Reporting) {
        ...
        (function (Internal) {
            ...
            var restoreViewPortFunc = null;
            function createFullscreenComputed(element, parent) {
                var _fullscreen = ko.observable(false);
                var func = function () {
                    var isFullscreen = document.fullscreen || !!document["msFullscreenElement"];
                    if (isFullscreen) {
                        if (restoreViewPortFunc)
                            return;
                        var viewport = $(DevExpress["viewPort"]())[0];
                        var viewportClassName = viewport.className;
                        var elementClassName = element.className;
                        restoreViewPortFunc = function () {
                            element.className = elementClassName;
                            DevExpress["viewPort"](viewport);
                            viewport.className = viewportClassName;
                        };
                        DevExpress["viewPort"](element);
                    }
                    else {
                        if (!restoreViewPortFunc)
                            return;
                        restoreViewPortFunc();
                        restoreViewPortFunc = null;
                    }
        ...
        (function (Viewer) {
            ...
            (function (Internal) {
                ...
                function createDesktopPreview(element, callbacks, parametersInfo, handlerUri, previewVisible, applyBindings, allowURLsWithJSContent, rtl, tabPanelSettings) {
                    ...
                    var globalActionProviders = ko.observableArray([new Internal.PreviewActions(reportPreview), exportModel, searchModel, new Internal.PreviewDesignerActions(reportPreview, element)]);
            ...
            (function (Internal) {
                ...
                var DocumentMapModel = (function () {
                    function DocumentMapModel(reportPreview) {
                        ...
                        this.tabInfo = new DevExpress.Analytics.Utils.TabInfo({
                            text: "Document Map",
            ...
            (function (Widgets) {
                ...
                var MultiValueEditor = (function (_super) {
                    ...
                    MultiValueEditor.prototype._createOptions = function (helper) {
                        if (!helper)
                            return null;
                        return new Internal.MultiValueEditorOptions(helper.value, helper.items);
                    };
                    return MultiValueEditor;
                }(DevExpress.Analytics.Widgets.Editor));
                Widgets.MultiValueEditor = MultiValueEditor;
                var PictureEditMode;
                    ...
                    var PictureEditorActionProvider = (function (_super) {
                        ...
                        PictureEditorActionProvider.prototype.createSizingAction = function () {
                            ...
                            var popupOptions = this._initPopupOptions({
                                ...
                                contentData: {
                                    sizeModeText: DevExpress.Analytics.Utils.getLocalization("Size mode", "DevExpress.XtraReports.UI.XRPictureBox.Sizing"),
                                    ...
                                    alignmentText: DevExpress.Analytics.Utils.getLocalization("Image Alignment", "DevExpress.XtraReports.UI.XRPictureBox.ImageAlignment"),
                ...
                Widgets.editorTemplates = {
                    ...
                    multiValueSelectBox: { header: "dxrd-multivalue-selectbox", editorType: MultiValueEditor },
            ...
            var ReportPreview = (function (_super) {
                ...
                ReportPreview.prototype._deserializeExportOptions = function (exportOptionsString, isMerged) {
                    ...
                    return (!this.reportId || isMerged) ? new Export.ExportOptionsMergedPreview(jsonModel) : new Export.ExportOptionsPreview(jsonModel);
                };
            ...
            var JSReportViewerBinding = (function (_super) {
                ...
                JSReportViewerBinding.prototype.applyBindings = function (element) {
                    ...
                    var applyModel = function () {
                        ...
                        self._createModel(element).done(function (result) {
                            self.sender.previewModel = result;
...
DevExpress.Analytics.Internal._definePropertyByString(DevExpress, "Report.Preview.MultiValueEditor", "Reporting.Viewer.Widgets.MultiValueEditor");
